...
const List<RoguelikeCard> kRoguelikeCards = [
  ...
  RoguelikeCard(
    id: 'unlock_cell_overheat',
    name: 'Magma Hücresi (🌋)',
    description: 'Izgarada 🌋 Magma hücresi belirir. Patladığında 2.5x Puan çarpanı kazandırır.',
    synergyNote: 'Yüksek risk, yüksek skor getirisi olan ateş elementi hücresi.',
    tier: RoguelikeCardTier.tier3,
    icon: Icons.whatshot_rounded,
    color: Color(0xFFFF5252),
    unlocksCellType: CellSpecialType.overheat,
  ),
  RoguelikeCard(
  ...
  RoguelikeCard(
    ...
    synergyNote: 'Kilitli engelleri kırarak ekstra skor ve enerji biriktirir.',
    tier: RoguelikeCardTier.tier3,
